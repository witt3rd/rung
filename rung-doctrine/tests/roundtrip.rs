...
fn coverage_is_reported() {
    ...
    assert_eq!(props, 390, "the corpus did not survive migration");
}
...
/// `questions/_evidence/`. These 23 are the claims of that kind.
#[test]
