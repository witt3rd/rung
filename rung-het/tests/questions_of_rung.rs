...
//! decidable sentence is evaluated against all eleven of them. If a sentence is
...
//! genuinely rung's: a [`Scheme`], a directory, eleven files, and the results.
//!
...
#[test]
fn the_eleven_questions_are_read_from_disk() {
    let r = load();
